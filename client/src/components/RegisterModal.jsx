...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl my-8 bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl animate-fadeIn overflow-hidden">
        {/* Loading Overlay */}
        {isLoading && (
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:flex md:w-2/5 bg-gradient-to-br from-gray-800 to-gray-900 p-8 flex-col justify-between">
            ...
            <div>
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Join HairAI Today</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-gray-800 border ${errors.username ? 'border-red-500' : 'border-gray-700'} text-white px-4 py-2.5 rounded-lg focus:outline-none focus:border-gray-500 placeholder-gray-500 text-sm`}
                  />
                  {errors.username && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-gray-800 border ${errors.email ? 'border-red-500' : 'border-gray-700'} text-white px-4 py-2.5 rounded-lg focus:outline-none focus:border-gray-500 placeholder-gray-500 text-sm`}
                  />
                  {errors.email && (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-800 border border-gray-700 text-white px-4 py-2.5 rounded-lg focus:outline-none focus:border-gray-500 placeholder-gray-500 text-sm"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-1.5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full bg-gray-800 border ${errors.password ? 'border-red-500' : 'border-gray-700'} text-white px-4 py-2.5 rounded-lg focus:outline-none focus:border-gray-500 placeholder-gray-500 pr-10 text-sm`}
                    />
                    <button
                      type="button"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full bg-gray-800 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-700'} text-white px-4 py-2.5 rounded-lg focus:outline-none focus:border-gray-500 placeholder-gray-500 pr-10 text-sm`}
                    />
                    <button
                      type="button"
